  ...
  if (format) {
    switch (format) {
      case "ISO_8601":
        ...
        break;
      case "RFC_2822":
        date = (0, import_dayjs.default)(content.slice(5), "DD MMM YYYY HH:mm:ss ZZ").unix();
        break;
      case "MYSQL":
        date = (0, import_dayjs.default)(content, "YYYY-MM-DD hh:mm:ss").unix();
        break;
      case "UNIX":
        date = (0, import_dayjs.default)(content).unix();
        break;
      default:
        date = (0, import_dayjs.default)(content, format, true).valueOf();
        break;
    }
  }
  return date;
...
//# sourceMappingURL=date-DDSQ467Y.js.map
