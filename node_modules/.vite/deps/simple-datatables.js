...
var Columns = class {
  ...
  sort(column, dir, init) {
    ...
    if (th.getAttribute("data-type") === "date") {
      ...
      waitFor.push(import("./date-DDSQ467Y.js").then(({ parseDate }) => (date) => parseDate(date, format)));
    }
    ...
    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
      ...
      if (this.dom.tHead) {
        ...
        if (this.options.scrollY.length) {
          ...
          this.headerTable.parentElement.style.paddingRight = `${this.headerTable.clientWidth - this.dom.clientWidth + parseInt(
