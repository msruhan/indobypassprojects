            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="d-flex flex-column h-100">
                  <h2 class="mb-0 font-weight-bolder">General Statisticsxxxxxx</h2>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <tr v-for="(sale, index) in sales" :key="index">
                      <td class="w-30">
                        <div class="px-2 py-1 d-flex align-items-center">
                          ...
                          <div class="ms-4">
                            <p class="mb-0 text-xs font-weight-bold">Countryz:</p>
                      ...
                      <td>
                        <div class="text-center">
                          <p class="mb-0 text-xs font-weight-bold">Salesz:</p>
